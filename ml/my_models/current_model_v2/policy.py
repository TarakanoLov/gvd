...
def make_model():
    ...
    x = Dense(12, activation='selu')(board_input)
...
class Agent(player.Player):
    ...
    def nextCard(self, other, only_drop=False):
        if not Agent.is_load:
           ...
           Agent.model.load_weights('my_models/current_model_v2/variants/model.h5')
    ...
    def fit(new_all_game_situation, new_card_to_use, new_action_val_array):
        ...
        Agent.model.save_weights('my_models/current_model_v2/variants/model.h5')
